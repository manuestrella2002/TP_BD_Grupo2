...
SELECT	Emp.DNI_empleado AS DNI_responsable,
		CONCAT(Emp.Nombre_empleado, " ", Emp.Apellido_empleado) AS Nombre_responsable,
...
WHERE	YEAR(C.Fecha) = 2024 
		AND MONTH(C.Fecha) BETWEEN 1 AND 5
GROUP BY Emp.DNI_empleado
